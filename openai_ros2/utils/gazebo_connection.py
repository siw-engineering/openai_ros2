...
from biped_gym.utils import ut_generic, ut_launch, ut_biped, ut_param_server
from gym import utils, spaces
import numpy as np
import time,gym,copy,os,threading
gym.logger.set_level(40)  # hide warnings

class RobotArmEnvByFrank(gym.Env):
    ...
    def __init__(self):
        ...
        joint_names = ut_param_server.getJoints(self.node, self.robot_name)
        JOINT_PUBLISHER = '/' + self.robot_name + '/control'
